...
export async function generateMetadata() {
  ...
  return {
    ...
    description: "Каталог профессиональных моделей в Москве. Выберите модель из нашего эксклюзивного каталога К.Л.С.",
    keywords: "каталог моделей, профессиональные модели, премиум модели, Москва, К.Л.С.",
    openGraph: {
      title: settings.models_title,
